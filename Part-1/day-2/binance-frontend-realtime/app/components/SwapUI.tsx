      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-1">
          <div className="px-2 sm:px-3">
            <div className="flex flex-row flex-0 gap-3 sm:gap-5">
              <LimitButton type={type} setType={setType} />
              <MarketButton type={type} setType={setType} />
            </div>
          </div>
          <div className="flex flex-col px-2 sm:px-3">
            <div className="flex flex-col flex-1 gap-2 sm:gap-3 text-baseTextHighEmphasis">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col relative">
                  <input
                    step="0.01"
                    placeholder="0"
                    className="h-10 sm:h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-10 sm:pr-12 text-right text-xl sm:text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0"
                    type="text"
                    value="134.38"
                  />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-wrap justify-center flex-row mt-2 gap-2 sm:gap-3">
                <div className="flex items-center justify-center flex-row rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs cursor-pointer bg-baseBackgroundL2 hover:bg-baseBackgroundL3">
                  25%
                </div>
                <div className="flex items-center justify-center flex-row rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs cursor-pointer bg-baseBackgroundL2 hover:bg-baseBackgroundL3">
                  50%
            ...
            <button
              type="button"
              className="font-semibold focus:ring-blue-200 focus:none focus:outline-none text-center h-10 sm:h-12 rounded-xl text-sm sm:text-base px-3 sm:px-4 py-1.5 sm:py-2 my-3 sm:my-4 bg-greenPrimaryButtonBackground text-greenPrimaryButtonText active:scale-98"
              data-rac=""
            >
              Buy
            </button>
